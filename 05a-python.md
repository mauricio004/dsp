...
>> Both lists and tuples are ordered sequence of values.  Python identifies each value by an index.  The main difference is that lists are mutables and tuples are immutable.  We use Tuples as keys in dictionaries as they are inmutable.
---
